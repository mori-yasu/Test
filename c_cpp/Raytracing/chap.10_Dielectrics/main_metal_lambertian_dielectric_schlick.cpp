...
int main()
{
    ...
    const char *filepath ="D:\\vsc\\c_cpp\\Raytracing\\chap.10_Dielectrics\\metal_lambertian_dielectric_total_reflection_fine.ppm";
    ...
    else
    {
        ...
        list[4] = new sphere(vec3(-1, 0, -1), -0.48, new dielectric(1.5));              //中空ガラス表現するとき。負の半径いれてやると法線内向きのガラスを入れられる。
