...
int main()
{
    ...
    const char *filepath ="D:\\vsc\\c_cpp\\Raytracing\\chap.10_Dielectrics\\metal_lambertian_dielectric.ppm";
    ...
    else
    {
        ...
        list[3] = new sphere(vec3(-1, 0, -1), 0.5, new dielectric(1.3));              //金属マテリアル  //fuzziness1.0...反射がランダム方向に散乱する。
