...
int main()
{
    ...
    const char *filepath ="D:\\workspace\\vsc\\c_cpp\\Raytracing\\one_weekend\\chap.8_Metal\\metal_lambertian.ppm";
    ...
    else
    {
        ...
        list[2] = new sphere(vec3(1, 0, -1), 0.5, new metal(vec3(0.8, 0.6, 0.2)));               //金属マテリアル
